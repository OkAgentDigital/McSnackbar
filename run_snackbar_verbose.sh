...
# Run Snackbar with verbose output
cd "$(dirname "$0")" || exit 1
...
if [ -f "./.build/arm64-apple-macosx/debug/Snackbar" ]; then
    ...
    echo "Executable exists: $(ls -la ./.build/arm64-apple-macosx/debug/Snackbar)"
    echo "Current directory: $(pwd)"
    echo "Running: ./.build/arm64-apple-macosx/debug/Snackbar"
    ...
    echo "Executable exists: $(ls -la ./.build/debug/Snackbar)"
    echo "Current directory: $(pwd)"
    echo "Running: ./.build/debug/Snackbar"
