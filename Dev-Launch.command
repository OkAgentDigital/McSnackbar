...
if ! command -v xcodebuild &> /dev/null; then
    ...
    error "Please install Xcode and run: xcode-select --install"
    exit 1
fi
...
# Step 4: Verify all 6 snacks are in the resources
...
log ""
log "Look for the 🍔 or note.text icon in your menu bar!"
log ""
